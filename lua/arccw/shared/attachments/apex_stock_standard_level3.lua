att.PrintName = "Standard Stock - Level 3"
att.Icon = Material("entities/attach_icons/apex_stock_3.png", "mips smooth")
...
att.EntityIcon = "entities/attach_icons/apex_stock_3.png"