sound.Add( {
    name = "ArcCW_APEX.Melee.Hit.Default",
...
sound.Add( {
    name = "ArcCW_APEX.Melee.Hit.Flesh",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
--    pitch = {95, 105},
...
sound.Add( {
    name = "ArcCW_APEX.Melee.Swing.Left",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
--    pitch = {95, 105},
...
sound.Add( {
    name = "ArcCW_APEX.Melee.Swing.Right",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
--    pitch = {95, 105},
...
sound.Add( {
    name = "ArcCW_APEX.Melee.Swing.Upper",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
    sound = {
...
sound.Add( {
    name = "ArcCW_APEX.Rampart.Wrench.Hit_Default",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
    sound = {
...
sound.Add( {
    name = "ArcCW_APEX.Rampart.Wrench.Hit_Flesh",
    channel = CHAN_WEAPON + 6,
    volume = 1.0,
    level = 120,
    sound = {
...
sound.Add( {
    name = "ArcCW_APEX.Rampart.Wrench.Swing_Foley",
    channel = CHAN_ITEM + 6,
    volume = 1.0,
    level = 120,
    sound = {
...
sound.Add( {
    name = "ArcCW_APEX.Rampart.Wrench.Draw",
    channel = CHAN_ITEM + 6,
    volume = 1.0,
    level = 120,
    sound = {
